...
public class EPFKPSPublicSoap
{
    ...
    public EPFKPSPublicSoap(){}

    public EPFKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public EPFKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        EPFExtendedSoapSerializationEnvelope envelope= new EPFExtendedSoapSerializationEnvelope(EPFExtendedSoapSerializationEnvelope.VER11);
