...
public class EPFExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(EPFDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new EPFStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static EPFDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static EPFDateTimeConverter dateTimeConverter = new EPFStandardDateTimeConverter();

    public EPFExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public EPFExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new EPFMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=EPFHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,EPFExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=EPFHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
